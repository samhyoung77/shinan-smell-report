...
export function renderKPI(container, { today = 0, week = 0, month = 0 } = {}) {
  container.innerHTML = `
    <div class="kpi" role="list">
      <div class="kpi__card" role="listitem" aria-label="오늘 신고 ${today}건">
        <span class="kpi__num">${today}</span>
        <span class="kpi__label">오늘</span>
      </div>
      <div class="kpi__card" role="listitem" aria-label="이번 주 신고 ${week}건">
        <span class="kpi__num">${week}</span>
        <span class="kpi__label">이번 주</span>
      </div>
      <div class="kpi__card" role="listitem" aria-label="이번 달 신고 ${month}건">
