...
집 앞 개울가에서 나는 악취를 익명으로 신고하고, 단지·동별로 언제 어디서 냄새가 발생했는지를 통계로 비교해 볼 수 있는 모바일 웹앱.

**공개 URL:** https://chosamhyoung.github.io/shinan-smell-report/
...
- **원터치 신고** — 지도 탭 + 강도 선택 + 버튼 하나
- **날짜 지정 가능** — 헤더의 달력 아이콘으로 최근 30일 내 다른 날짜 신고
- **24시간 내 취소** — 실수 신고는 24시간 안에 스스로 취소 가능
...
- 삭제는 24시간 이내 본인 신고만 (localStorage에 자기 report ID 보관)
